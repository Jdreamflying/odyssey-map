...
export const CARTOGRAPHY_ASSETS = [
  ...
  { name: 'apennines-s', type: 'mountain', src: 'mountains/range-high-massif.png',
  ...
  /* 原来在 18.3E / 42.6N：那个点既在海里（迪纳拉山脊在东北方的内陆），
     ...
     并收窄一档给同名标注让位。 */
  { name: 'dinara', type: 'mountain', src: 'mountains/range-jagged-peaks.png',
    lon: 19.4, la: 42.15, scale: 0.038, rotation: 33, opacity: 0.42, anchor: 'bottom' },
  { name: 'pindus', type: 'mountain', src: 'mountains/range-jagged-peaks.png',
    lon: 21.2, la: 39.9, scale: 0.046, rotation: 62, opacity: 0.44, anchor: 'bottom' },
  { name: 'taygetus', type: 'mountain', src: 'mountains/range-high-massif.png',
    lon: 22.35, la: 37.15, scale: 0.032, rotation: 72, opacity: 0.4, anchor: 'bottom' },
  { name: 'creta-ida', type: 'mountain', src: 'mountains/range-broad-ridge.png',
    lon: 24.7, la: 35.25, scale: 0.034, rotation: -4, opacity: 0.42, anchor: 'bottom' },
  { name: 'anatolia-taurus', type: 'mountain', src: 'mountains/range-high-massif.png',
  ...
  { name: 'atlas-tell', type: 'mountain', src: 'mountains/range-plateau-scarp.png',
    lon: 9.7, la: 36.35, scale: 0.042, rotation: -8, opacity: 0.43, anchor: 'bottom' },
  { name: 'sicilia-interior', type: 'mountain', src: 'mountains/range-plateau-scarp.png',
  ...
  { name: 'scardus-orbelus', type: 'mountain', src: 'mountains/range-jagged-peaks.png',
    lon: 21.15, la: 41.85, scale: 0.05, rotation: -14, opacity: 0.42, anchor: 'bottom' },
  { name: 'haemus', type: 'mountain', src: 'mountains/range-broad-ridge.png',
    lon: 25.9, la: 42.3, scale: 0.042, rotation: -6, opacity: 0.4, anchor: 'bottom' },
  { name: 'dorsale-tunisia', type: 'mountain', src: 'mountains/range-plateau-scarp.png',
  ...
  /* ══ 聚落 ══════════════════════════════════════════════════
     ...
     位置一律挑有史实依据的地点。 */
  { name: 'carthago-city', type: 'settlement', src: 'settlements/walled-city.png',
    lon: 10.3, la: 36.9, scale: 0.032, opacity: 0.5, anchor: 'bottom' },
  { name: 'cyrene-ruins', type: 'settlement', src: 'settlements/temple-ruins.png',
    lon: 21.9, la: 32.9, scale: 0.03, opacity: 0.5, anchor: 'bottom' },
  { name: 'tarentum-harbour', type: 'settlement', src: 'settlements/harbour-town.png',
    lon: 17.3, la: 40.5, scale: 0.028, opacity: 0.48, anchor: 'bottom' },
  { name: 'sardinia-lighthouse', type: 'settlement', src: 'settlements/lighthouse-rock.png',
    lon: 9.5, la: 39.45, scale: 0.026, opacity: 0.48, anchor: 'bottom' },
  /* 内陆两枚：非洲一侧的断柱、色雷斯一侧的城墙。都是真地点，
     也正好落在南北两片最大的陆上空白里。净空 49 / 34 */
  { name: 'capsa-ruins', type: 'settlement', src: 'settlements/temple-ruins.png',
    lon: 8.95, la: 34.05, scale: 0.03, opacity: 0.46, anchor: 'bottom' },
  { name: 'hadrianopolis-city', type: 'settlement', src: 'settlements/walled-city.png',
  ...
  { name: 'galley-ionian', type: 'ship', src: 'ships/galley-oared.png',
  ...
  { name: 'serpent-internum', type: 'sea', src: 'sea/sea-serpent-horned.png',
    lon: 17.3, la: 32.72, scale: 0.042, rotation: -3, opacity: 0.46 },
  { name: 'whale-libycum', type: 'sea', src: 'sea/whale-spouting.png',
    lon: 27.05, la: 34.5, scale: 0.04, rotation: 2, opacity: 0.44 },
  { name: 'dragon-tyrrhenum', type: 'sea', src: 'sea/sea-dragon-finned.png',
  ...
  { name: 'wave-band-ionium', type: 'wave', src: 'sea/wave-band.png',
    lon: 17.15, la: 35.55, scale: 0.028, rotation: -1, opacity: 0.32 },
  { name: 'wave-band-malta', type: 'wave', src: 'sea/wave-band.png',
    lon: 14.65, la: 34.85, scale: 0.024, rotation: 1, opacity: 0.3 },
  { name: 'wave-band-libycum', type: 'wave', src: 'sea/wave-band.png',
  ...
  { name: 'rose-west', type: 'navigation', src: 'navigation/compass-rose.png',
    lon: 10.7, la: 38.3, scale: 0.092, opacity: 0.5 },
  /* 西西里海峡：地中海东西两盆之间唯一的门，从腓尼基人到 18 世纪
     所有东西向航行都要穿过它。净空 58 */
  { name: 'rose-sicily-strait', type: 'navigation', src: 'navigation/compass-rose.png',
  ...
  { name: 'rose-ionium', type: 'navigation', src: 'navigation/compass-rose.png',
    lon: 18.55, la: 36.2, scale: 0.072, rotation: 3, opacity: 0.46 },
  { name: 'rose-libycum', type: 'navigation', src: 'navigation/compass-rose.png',
  ...
  { name: 'rose-aegean-n', type: 'navigation', src: 'navigation/compass-rose.png',
    lon: 24.45, la: 39.75, scale: 0.05, rotation: -5, opacity: 0.4 },
  /* 唯一一枚锚：迦太基外海的锚地，紧贴着上面那枚城墙记号。
     锚与城成对出现是海图的定式 —— 城告诉你那里有人，锚告诉你船能停。净空 19 */
  { name: 'anchor-carthago', type: 'navigation', src: 'navigation/anchor.png',
